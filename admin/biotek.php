                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="biotek.php">
                                <button type="button" class="btn shadow-inset btn-primary btn-block" tabindex="0"><span class="fas fa-map-signs mr-2"></span>Biotek</button>
                            </a>
                                                    ...
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <img class="btn shadow-inset"
                                                                src="../assets/img/denah/<?= $bio ["denah"]; ?>" alt="">
                                                        </div>
                                                        <div class="mb-3">
