                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="gedunglama.php">
                                <button type="button" class="btn  btn-primary btn-block" tabindex="0"><span class="fas fa-map-signs mr-2"></span>Gedung Lama</button>
                            </a>
                            ...
                            <a class="nav-link" href="siskom.php">
                                <button type="button" class="btn shadow-inset btn-primary btn-block" tabindex="0"><span class="fas fa-map-signs mr-2"></span>Siskom</button>
                            </a>
                        </div>
                        </div>
                    </div>
                                                    ...
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <img class="btn shadow-inset"
                                                                src="../assets/img/denah/<?= $sis ["denah"]; ?>" alt="">
                                                        </div>
                                                        <div class="mb-3">
