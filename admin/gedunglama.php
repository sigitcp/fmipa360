...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-white">
            <a class="navbar-brand text-gray" href="index.html"><img src="../assets/img/Lambang_Universitas_Tanjungpura.png" width="Logo"> FMIPA 360</a>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="index.php">
                                <button type="button" class="btn btn-primary btn-block" tabindex="0"><span class="fas fa-university mr-2"></span>Dashboard</button>
                            </a>
                            ...
                            <a class="nav-link" href="gedungbaru.php">
                                <button type="button" class="btn btn-primary btn-block" tabindex="0"><span class="fas fa-map-signs mr-2"></span>Gedung Baru</button>
                            </a>
                            <a class="nav-link" href="gedunglama.php">
                                <button type="button" class="btn shadow-inset btn-primary btn-block" tabindex="0"><span class="fas fa-map-signs mr-2"></span>Gedung Lama</button>
                            </a>
                            <a class="nav-link" href="biotek.php">
                                <button type="button" class="btn btn-primary btn-block" tabindex="0"><span class="fas fa-map-signs mr-2"></span>Biotek</button>
                            </a>
                            <a class="nav-link" href="siskom.php">
                                <button type="button" class="btn btn-primary btn-block" tabindex="0"><span class="fas fa-map-signs mr-2"></span>Siskom</button>
                            </a>
                        </div>
                        </div>
                    </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <input type="hidden" name="id" value="<?= $glm ["id"];?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <img class="btn shadow-inset"
                                                                src="../assets/img/denah/<?= $glm ["denah"]; ?>" alt="">
                                                        </div>
                                                        <div class="mb-3">
