...
include '../AdminControllers/LoginController.php';
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <?php if (isset($error)): ?>
                                        <div class="alert alert-danger alert-dismissible shadow-soft fade show" role="alert">
                                            ...
                                            <span class="alert-inner--text"><strong>Sorry</strong> Username or password wrong!!!</span>
                                    ...
                                    <?php endif; ?>
                                         ...
                                         <form action="" method="post">
                                            <div class="form-group">
                                                <label class="small mb-1" for="username">Enter Username</label>
                                                <input class="form-control py-4" id="username" name='username' placeholder="Username" />
                                            </div>
                                            <div class="form-group">
