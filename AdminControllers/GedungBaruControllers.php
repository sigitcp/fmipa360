...
function creategedungbaru($data){
    global $conn;
    ...
    $query = "INSERT INTO gedungbaru VALUES ('','$nama', '$luas', '$kapasitas', '$denah')";
...
function editgedungbaru($data){
  ...
  $query = "UPDATE gedungbaru SET nama = '$nama', luas = '$luas', kapasitas = '$kapasitas', denah = '$denah'WHERE id = $id";
...
function delete($id){
  global $conn;
  mysqli_query($conn, "DELETE FROM gedungbaru WHERE id = $id");
  return mysqli_affected_rows($conn);
}
