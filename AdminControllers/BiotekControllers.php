...
function create($data){
    ...
    $query = "INSERT INTO biotek VALUES ('','$nama', '$luas', '$kapasitas', '$denah')";
...
function edit($data){
  ...
  $query = "UPDATE biotek SET nama = '$nama', luas = '$luas', kapasitas = '$kapasitas', denah = '$denah'WHERE id = $id";
...
function delete($id){
  global $conn;
  mysqli_query($conn, "DELETE FROM biotek WHERE id = $id");
  return mysqli_affected_rows($conn);
}
