...
function creategedunglama($data){
    global $conn;
    ...
    $query = "INSERT INTO gedunglama VALUES ('','$nama', '$luas', '$kapasitas', '$denah')";
...
function editgedunglama($data){
  ...
  $query = "UPDATE gedunglama SET nama = '$nama', luas = '$luas', kapasitas = '$kapasitas', denah = '$denah'WHERE id = $id";
...
function delete($id){
  global $conn;
  mysqli_query($conn, "DELETE FROM gedunglama WHERE id = $id");
  return mysqli_affected_rows($conn);
}
